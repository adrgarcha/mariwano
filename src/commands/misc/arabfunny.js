...
module.exports = {
  run: async ({ interaction }) => {
    ...
    const arabFunnySentences = [
      "لا يسمح للكفذا قيل لهم لا تفسدوا في الأرض قالوا إنما نحن مصلحذا قيل لهم لا تفسدوا في الأرض قالوا إنما نحن مصلحذا قيل لهم لا تفسدوا في الأرض قالوا إنما نحن م😂صلحذا قيل لهم لا تفسدوا في الأرض قالوا إنما نحن مصلحذا قيل لهم لا تفسدوا في الأرض قالوا إنما نحن مصلحذ😂ا قيل لهم لا تفسدوا في الأرض قالوا إنما نحن مصلحذا قيل له😝م لا تفسدوا في الأرض قالوا إنما نحن مصلحذا قيل 🥵لهم لا تفسدوا في الأرض قالوا إنما نحن مصلحذا قيل لهم لا ت🥰فسدوا في الأرض قالوا إنما نحن مصلحذا قيل لهم لا تفسدوا في الأرض قالوا إنما نحن مصلحذا قيل لهم لا تفسدوا في الأرض قالوا إنما نحن مصلحار على هذا🥵 الخادم، بسم🤬🤬 الله😂🤣",
      ...
      "فيديو آخر يا شعبي، م🤮ن يريد أن يضيع ILLOJUAN وقته فليضيعه، 😳فلنبدأ بهذا🤣 الهراءته فليضيته فليضيته فليضيته فليضيته فليضيته فليضيته فليضيته فليضيته فليضيته فليضيته فليضيته فليضيته فليضيته فليضيته فليضيته فليضيته فليضيته فليضي",
    ...
    const arabFunnyFrase =
      arabFunnySentences[Math.floor(Math.random() * arabFunnySentences.length)];
